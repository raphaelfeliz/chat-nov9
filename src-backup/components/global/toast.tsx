/* *file-summary*
PATH: src/components/global/toast.tsx
...
- This is a core UI primitive used globally. The `ToastProvider` and `ToastViewport` are typically rendered high up in the component tree, such as in 'src/app/layout.tsx', to ensure availability across the app.
- It relies on the class utility function imported from '@/lib/utils.ts' for Tailwind class merging.
- It exposes various types (`ToastProps`, `ToastActionElement`) for use by the hook that triggers the toast notifications.
