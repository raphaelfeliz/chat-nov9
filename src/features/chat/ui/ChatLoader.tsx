...
SUMMARY: This is a self-contained "dumb" component with its own <style> tag
         for the keyframe animations. It is imported by ChatBubble.tsx
         to be displayed when the AI is thinking.

RELATES TO OTHER FILES:
- This is a "dumb" UI component.
- It is imported and rendered by `src/features/chat/ui/ChatBubble.tsx`.
